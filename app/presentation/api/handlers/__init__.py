...
from app.presentation.api.handlers.company.handler import router as public_company_router
from app.presentation.api.handlers.company.public_handler import router as company_router
...
routers.include_router(public_company_router)
